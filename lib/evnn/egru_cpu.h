    ...
    namespace v0
    {
        namespace egru
        {
            ...
            public:
                ...
                // Performs one forward iteration of the EGRU cell.
                //
                ...
                // x: [N,C] the EGRU input for this iteration (N vectors, each with dimension C).
                // h: [N,H] the t-1 iteration's `h_out` or the initial hidden state if this is the
                //     t=0 iteration (typically zeros).
                // h_out: [N,H] the EGRU's output, and the input to the next iteration's `h`. This
            ...
            public:
                ...
                // Performs one backward iteration of the EGRU cell.
                //
                ...
                // x_t: [C,N] the transpose of the EGRU input for this iteration.
